...
const GLint WIN_LEFT_BIT = 0x01;   //0 0 0 1
const GLint WIN_RIGHT_BIT = 0x02;  //0 0 1 0
const GLint WIN_BOTTOM_BIT = 0x04; //0 1 0 0
const GLint WIN_TOP_BIT = 0x08;    //1 0 0 0
